...
SUB_RUTINA formato_trabajador
   ...
   SI ( $tabla:'EXPERIENCIA_LABORAL' = 2 ) $experiencia := 'MENOS DE 1 AÑO' FIN_SI
   SI ( $tabla:'EXPERIENCIA_LABORAL' = 3 ) $experiencia := '1 A 2 AÑOS' FIN_SI
   SI ( $tabla:'EXPERIENCIA_LABORAL' = 4 ) $experiencia := '2 A 3 AÑOS' FIN_SI
   SI ( $tabla:'EXPERIENCIA_LABORAL' = 5 ) $experiencia := '3 A 5 AÑOS' FIN_SI
   SI ( $tabla:'EXPERIENCIA_LABORAL' = 6 ) $experiencia := 'MAS DE 5 AÑOS' FIN_SI
